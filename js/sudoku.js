...
Sudoku = (function (window, document, undefined) {
    ...
    Sudoku = function (options) {
        ...
        this.dig = function(_solution, level){
            ...
            //Quick and Dirty solution for randomizing empty cells
            var sorting = function(a,b){ return (num_num[b.value] - num_num[a.value]) || (level<3?(Math.floor(Math.random()*2)*2-1):(a.id-b.id)); };
